window.allPlacesData = [
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Khanapur",
          "frequency": "Every 45 mins",
          "duration": "1 hr",
          "fare": "~Rs.40"
        },
        {
          "route": "Khanapur -> Bhimagad (shared jeep)",
          "frequency": "On demand",
          "duration": "30 min",
          "fare": "~Rs.25-30"
        }
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Gokak",
          "frequency": "Every 30 mins",
          "duration": "1.5 hrs",
          "fare": "~Rs.60"
        },
        {
          "route": "Gokak -> Hidkal Junction",
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Jamboti",
          "frequency": "3-4 buses/day",
          "duration": "1.5 hrs",
          "fare": "~Rs.55"
        },
        {
          "route": "Belagavi -> Panaji (Goa) via Chorla",
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        ...
        {
          "route": "Gokak -> Godchinamalaki (shared auto)",
          "frequency": "On demand",
          "duration": "30 min",
          "fare": "~Rs.40"
        }
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Kittur (KSRTC)",
          "frequency": "Every 1 hr",
          "duration": "1 hr 15 min",
          "fare": "~Rs.55"
        },
        {
          "route": "Belagavi -> Dharwad (stops at Kittur)",
          "frequency": "Frequent",
          "duration": "1 hr",
          "fare": "~Rs.60"
        }
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Nipani",
          "frequency": "Every 1 hr",
          "duration": "2 hrs",
          "fare": "~Rs.90"
        },
        {
          "route": "Nipani -> Khidrapur (local)",
          "frequency": "3-4/day",
          "duration": "45 min",
          "fare": "~Rs.30"
        }
      ],
      "train": "Belagavi Railway Station -> Kolhapur (1.5 hrs), then taxi ~Rs.600.",
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Fort Circle",
          "frequency": "Every 15 mins",
          "duration": "12 min",
          "fare": "~Rs.10"
        }
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Rakaskop (Khanapur Road)",
          "frequency": "4-5/day",
          "duration": "35 min",
          "fare": "~Rs.25"
        }
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Ramdurg (KSRTC)",
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Kanbargi village",
          "frequency": "Every 30 mins",
          "duration": "25 min",
          "fare": "~Rs.15"
        }
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Panaji (via Chorla)",
          "frequency": "Several daily KSRTC/Goa Kadamba buses",
          "duration": "1.5 hrs",
          "fare": "~Rs.70"
        }
      ],
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Chandgad",
          "frequency": "Regular MSRTC/KSRTC buses",
          "duration": "1.5 hrs",
          "fare": "~Rs.60"
        }
      ],
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Vidhana Soudha",
          "frequency": "Every 20 mins",
          "duration": "15 min",
          "fare": "~Rs.15"
        }
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Saundatti (KSRTC)",
          "frequency": "Every 1 hr",
          "duration": "2 hrs",
          "fare": "~Rs.90"
        },
        {
          "route": "Saundatti -> Yellamma Gudi (temple bus)",
          "frequency": "Every 30 mins",
          "duration": "20 min",
          "fare": "~Rs.15"
        }
  ...
  },
  {
    ...
    "transport": {
      ...
      "bus": [
        {
          "route": "Belagavi CBT -> Yellur village",
          "frequency": "3-4 buses/day",
          "duration": "35 min",
          "fare": "~Rs.20"
        }
